...
function fillParameter(data){
    ...
    //数据回显
    $(".fileSize").val(nullData(data.fileSize)); 
    $(".adminPhone").val(nullData(data.adminPhone));
    ...
    $(".oddsOfWinning").val(data.oddsOfWinning);
...
layui.use(['form','jquery',"layer"],function() {
    ...
    form.on("submit(systemConfig)",function(data){
       ...
       var systemConfig = {};
        ...
        systemConfig.fileSize = $(".fileSize").val();
        systemConfig.adminPhone = $(".adminPhone").val();
        ...
        systemConfig.oddsOfWinning = $(".oddsOfWinning").val();
        systemConfig.redPacketMax = 20000;
        systemConfig.redPacketMin = 1;
        systemConfig.transferMax = 1;
