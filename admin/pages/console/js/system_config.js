...
function fillParameter(data){
    ...
    $(".accountSearchUser").val(data.accountSearchUser);
    ...
    $(".accountSearch").val(data.accountSearch);// 使用Google地图
    ...
    $(".chargeMaxAmount").val(data.chargeMaxAmount);
    $(".chargeDayMaxAmount").val(data.chargeDayMaxAmount);
    $(".withdrawRates").val(data.withdrawRates);
    $(".countMaxRates").val(data.countMaxRates);
    $(".withdrawMinAmount").val(data.withdrawMinAmount);
    $(".withdrawMaxAmount").val(data.withdrawMaxAmount);
    $(".withdrawDayMaxAmount").val(data.withdrawDayMaxAmount);
    $(".gongZhongMessage").val(data.gongZhongMessage);
    $(".userGetRedPacket").val(data.userGetRedPacket);
...
layui.use(['form','jquery',"layer"],function() {
    ...
    form.on("submit(systemConfig)",function(data){
       ...
       systemConfig.giftRatio = $(".giftRatio").val();
        ...
        //昵称搜索 精准、、模糊 关闭
        systemConfig.accountSearchUser = $(".accountSearchUser").val();
        ...
        //允许通讯号搜索用户 开启关闭
        systemConfig.accountSearch = $(".accountSearch").val();
        ...
        systemConfig.gongZhongMessage = $(".gongZhongMessage").val();
        systemConfig.userGetRedPacket = $(".userGetRedPacket").val();




        systemConfig.chargeMaxAmount = $(".chargeMaxAmount").val();
        systemConfig.chargeDayMaxAmount = $(".chargeDayMaxAmount").val();
        systemConfig.withdrawRates = $(".withdrawRates").val();
        systemConfig.countMaxRates = $(".countMaxRates").val();
        systemConfig.withdrawMinAmount = $(".withdrawMinAmount").val();
        systemConfig.withdrawMaxAmount = $(".withdrawMaxAmount").val();
        systemConfig.withdrawDayMaxAmount = $(".withdrawDayMaxAmount").val();
