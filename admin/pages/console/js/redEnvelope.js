...
layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        ,cols: [[ //表头
            ...
            ,{field: 'over', title: '未领金额',sort: true, width:120,templet : function (d){
            	return "<font color=blue>"+d.over+"</font>"
            }}
            ,{field: 'count', title: '红包个数',sort: true, width:120,templet : function (d){
            	return d.receiveCount +"/"+d.count;
            }}
            
            ,{field: 'type', title: '红包类型',sort: true, width:120,templet : function (d){
            	var type = "普通红包";
            	if(d.type == 2){
            		type = "拼手气红包";
            	}
