package com.shiku.mianshi.utils.agent;

import com.alibaba.fastjson.JSONObject;
import com.shiku.mianshi.utils.sendpay.sdk.encrypt.CertUtil;
import com.shiku.mianshi.utils.sendpay.sdk.encrypt.CryptoUtil;
...
public class SendBase {
	...
	public static  Logger logger = LoggerFactory.getLogger(SendBase.class);
	...
	* @return
	...
	public static JSONObject requestServer(JSONObject request, String reqAddr, String transCode, String merId, String plId) {
		...
		try {
			...
			String accessType = SendBase.getAccessType(plId, merId);
