...
public class User {
	...
	private String backReg;//是否后台注册
	/**
	 * 按固定金额领取红包的用户
	 * 1000/30;1222/10;
	 */
	private BigDecimal userGetRedPacket=BigDecimal.ZERO;//
...
//	private String idCardNo;
	...
	// 朋友圈访问权限，不看他
	private @NotSaved boolean notSeeHim;

	// 朋友圈访问权限，不让他看
	private @NotSaved boolean notLetSeeHim;
	...
	private String valiCode;//独有的验证码


	private String ip; // 登录时的IP
	private String regIp; //注册号的 IP
	private Integer banIp =0;// 0正常 -1 被ban
	...
	public static class UserSettings {
		...
		public static DBObject getDefault() {
			...
			dbObj.put("accountSearch", config.getAccountSearch());// 是否允许昵称号搜索
			...
			dbObj.put("authSwitch", 0); //授权开关   0-需要授权   1-不需要授权
			return dbObj;
		}
