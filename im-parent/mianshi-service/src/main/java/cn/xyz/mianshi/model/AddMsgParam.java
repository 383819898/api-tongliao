...
public class AddMsgParam extends BaseExample {
	...
	public String toString() {
		return "AddMsgParam [address=" + address + ", audios=" + audios + ", flag=" + flag + ", images=" + images
				+ ", messageId=" + messageId + ", remark=" + remark + ", source=" + source + ", text=" + text
				+ ", time=" + time + ", title=" + title + ", type=" + type + ", videos=" + videos + ", files=" + files
				+ ", visible=" + visible + ", lable=" + lable + ", musicId=" + musicId + ", sdkUrl=" + sdkUrl
				+ ", sdkIcon=" + sdkIcon + ", sdkTitle=" + sdkTitle + ", userLook=" + userLook + ", userNotLook="
				+ userNotLook + ", userRemindLook=" + userRemindLook + ", isAllowComment=" + isAllowComment + "]";
	}
