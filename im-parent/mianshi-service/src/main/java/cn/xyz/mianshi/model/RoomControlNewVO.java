...
public class RoomControlNewVO {
    private String id;
    private String roomId;
    private Integer roomOwnUserId;
    ...
    public Integer getRoomOwnUserId() {
        return this.roomOwnUserId;
    }
    ...
    public void setRoomOwnUserId(Integer roomOwnUserId) {
        this.roomOwnUserId = roomOwnUserId;
    }
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof RoomControlNewVO)) {
            return false;
        } else {
            RoomControlNewVO other = (RoomControlNewVO)o;
            if (!other.canEqual(this)) {
                ...
                label233: {
                    Object this$roomOwnUserId = this.getRoomOwnUserId();
                    Object other$roomOwnUserId = other.getRoomOwnUserId();
                    if (this$roomOwnUserId == null) {
                        if (other$roomOwnUserId == null) {
                            break label233;
                        }
                    } else if (this$roomOwnUserId.equals(other$roomOwnUserId)) {
                        break label233;
                    }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RoomControlNewVO;
    }
    ...
    public int hashCode() {
        ...
        Object $roomOwnUserId = this.getRoomOwnUserId();
        result = result * 59 + ($roomOwnUserId == null ? 43 : $roomOwnUserId.hashCode());
