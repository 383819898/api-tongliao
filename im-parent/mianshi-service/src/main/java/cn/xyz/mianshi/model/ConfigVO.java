...
public class ConfigVO {
	...
	private int redPacketMax;// 红包金额最大，单位分
	private int redPacketMin;// 红包金额最小，单位分
	...
	*/
	...
	private int accountSearchUser  = 0; //通讯号搜索用户  0：关闭   1：昵称精准搜索  2：昵称模糊搜索
	...
	private String userGetRedPacket;// 按比例领取红包的用户

	private int proportionGetRedPacket; // 领取红包的比例


	private int transferMax;// 转账最小金额
	/**
	 * 单次充值最大
	 */
	public BigDecimal chargeMinAmount = new BigDecimal("1");
	/**
	 * 单次充值最大
	 */
	...
	public ConfigVO(Config config,ClientConfig clientConfig) {
		...
		this.userGetRedPacket = clientConfig.getUserGetRedPacket();
		...
		this.accountSearchUser = config.getAccountSearchUser();
		...
		this.transferMax = clientConfig.getTransferMax();
	}
