  ...
  private MQConfig mqConfig;
    ...
    */
	...
	public void send(MessageBean messageBean){
			...
			log.info("=======sendwwwwwwwwwww====result =="+messageBean);
...
//			{"content":"123","fileSize":0,"fromUserId":"10000","fromUserName":"客服公众号","messageId":"3201a5df71534e2a93b069fd55b43f35","msgType":0,"timeSend":1643189671,"toUserId":"10000586","toUserName":"拒绝","type":1}
	...
	* @param     参数
	...
	public void pushAuthLoginDeviceMessage(Integer userId,String strKey){
		try {
			...
			//信息编号
			messageBean.setType(KXMPPServiceImpl.AUTHLOGINDEVICE);
			//信息接受方
